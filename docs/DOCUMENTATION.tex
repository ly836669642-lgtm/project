...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.72\textwidth]{ros_graph.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.48\textwidth]{route_speed_map.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.72\textwidth]{speed_profile.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.48\textwidth]{route_on_map.png}
